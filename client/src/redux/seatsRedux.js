...
export const loadSeatsRequest = () => {
  return async dispatch => {
    ...
    try {
      ...
      //await new Promise((resolve) => setTimeout(resolve, 2000)); usunac reducery do publikacji na heroku
...
export const addSeatRequest = (seat) => {
  return async dispatch => {
    ...
    try {
      ...
      //await new Promise((resolve) => setTimeout(resolve, 1000)); usunac reducery do publikacji na heroku
